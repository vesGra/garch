function [parameters, ll ,Ht, VCV, scores, diagnostics,Rt,Qt,Ao,Go,Bo,Ro]=dcc(data,dataAsym,m,l,n,p,o,q,gjrType,method,composite,startingVals,options)
...
isJoint = true;
isInference = true;
[ll,~,Rt,Qt,Ao,Go,Bo,Ro] = dcc_likelihood(parameters,data,dataAsym,m,l,n,[],[],backCast,backCastAsym,stage,composite,isJoint,isInference,gScale,univariate);
ll = -ll;
Ht = zeros(k,k,T);
for t=1:T
    h = sqrt(H(t,:));
