...
%     [Alternative_DCC101_1]=Cal_DCC_1(Alternative_LP,[],Alternative_w,[],'Alternative',1,0,1);
     [Equity_DCC101_1,a22,DIAGNOSTICS]=Cal_DCC_1(Equity_LP,[],Equity_w,[],'Equity',1,0,1);
...
if DCC101Every==1
    %1
    [SP_DAX_BEKK101_Every1]=Cal_DCC_Every(SP_DAX_LP,522,SP_DAX_w,[],'SP_DAX',1,0,1,1);
...
if BEKK101Every==1
    % 1 years
%     [SP_DAX_BEKK101_Every1]=Cal_BEKK_Every(SP_DAX_LP,522,SP_DAX_w,[],'SP_DAX',1,0,1,1);
...
if Factor101==1
    ...
    %}
    [Alternative_Factor101_1]=Cal_Factor_1(Alternative_LP,[],Alternative_w,[],'Alternative',1,0,1,3,1);
...
if Factor101Every==1
    ...
    [Equity_Factor101_Every]=Cal_Factor_Every_full(Equity_LP,[],Equity_w,[],'Equity',1,0,1,3,1);
...
%Factor Every 3
if Factor101Every3==1
    [Alternative_Factor101_Every]=Cal_Factor_Every(Alternative_LP,[],Alternative_w,[],'Alternative',1,0,1,5,3);
    [Equity_Factor101_Every]=Cal_Factor_Every_full(Equity_LP,[],Equity_w,[],'Equity',1,0,1,3,3);
    [FixIncome_Factor101_Every]=Cal_Factor_Every_full(FixIncome_LP,[],FixIncome_w,[],'FixIncome',1,0,1,3,3);
    [NewPF_Factor101_Every_Defensive,NewPF_Factor101_Every_Offensive]=Cal_Factor_Every(NewPF_LP,[],NewPF_w,NewPF_w2,'NewPF',1,0,1,3,3);
    [OldPF_Factor101_Every_Defensive,OldPF_Factor101_Every_Offensive]=Cal_Factor_Every(OldPF_LP,[],OldPF_w,OldPF_w2,'OldPF',1,0,1,6,3);
end
%Gogarch
if Gogarch11==1
...
%Gogarch Every
if Gogarch11Every==1
    [Alternative_Gogarch11_Every]=Cal_Gogarch_Every(Alternative_LP,[],Alternative_w,[],'Alternative',1,1,1);
...
%Gogarch Every 3
if Gogarch11Every3==1
    [Alternative_Gogarch11_Every]=Cal_Gogarch_Every(Alternative_LP,[],Alternative_w,[],'Alternative',1,1,3);
    [Equity_Gogarch11_Every]=Cal_Gogarch_Every(Equity_LP,[],Equity_w,[],'Equity',1,1,3);
    [FixIncome_Gogarch11_Every]=Cal_Gogarch_Every(FixIncome_LP,[],FixIncome_w,[],'FixIncome',1,1,3);
    [NewPF_BEKK101_Every_Defensive,NewPF_Gogarch11_Every_Offensive]=Cal_Gogarch_Every(NewPF_LP,[],NewPF_w,NewPF_w2,'NewPF',1,1,3);
    [OldPF_BEKK101_Every_Defensive,OldPF_Gogarch11_Every_Offensive]=Cal_Gogarch_Every(OldPF_LP,[],OldPF_w,OldPF_w2,'OldPF',1,1,3);
end
